...
full_2015_varOfInterest_withMajorityEthnicity <- full_2015_varOfInterest %>% mutate(EthnicMajority = case_when(
  White >= 50 ~ "White",
  ...
  Asian >= 50 ~ "Asian",
  True ~ "Diverse"),
  MaxEthnicity = max(White, Hispanic, Black, Native, Asian)
  EthnicPlurality = case_when(
  White >= 50 ~ "White",
  Hispanic >= 50 ~ "Hispanic",
  Black >= 50 ~ "Black",
  Native >= 50 ~ "Native",
