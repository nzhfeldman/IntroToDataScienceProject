...
full_2015_varOfInterest <- full_2015 %>%  select(Hispanic:Asian,IncomePerCap,Professional:Production,FiscalPolicy,EconomicFreedom, RegulatoryPolicy, PersonalFreedom, OverallFreedom)
...
full_2017_varOfInterest <- full_2017 %>%  select(Hispanic:Asian,IncomePerCap,Professional:Production,FiscalPolicy,EconomicFreedom, RegulatoryPolicy, PersonalFreedom, OverallFreedom)
```
