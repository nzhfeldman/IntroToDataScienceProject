...
```{r}
#Subsetting
dat1 <- subset(dat1, select = c(TotalPop, Hispanic, White, Black, Asian, Professional, Service, Office, Construction, Production, Unemployment, ipc))
...
>>>>>>> f44076427a3c8a511707117636a3414d615f2ffb
...
glr <- glm(ipc   ~ . - Professional, data = dat1 %>% select(-TotalPop), family = "binomial") 
summary(glr)
vif(glr)
coef <- coef(glr)
```
