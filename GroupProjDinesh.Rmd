...
reg.best10 <- regsubsets(IncomePerCap~. , data = full_2017_varOfInterest, nvmax = 17, nbest = 2, method = "exhaustive")  
...
```{r}
reg.forward10 <- regsubsets(IncomePerCap~. , data = full_2017_varOfInterest, nvmax = 17, nbest = 2, method = "forward")
