...
```{r Subsetting}
Freedom_2015 <- subset(full_2015_varOfInterest, select = c(OverallFreedom, EconomicFreedom, PersonalFreedom, RegulatoryPolicy, FiscalPolicy, IncomePerCap))
str(Freedom_2015)

Work_2015 <- subset(full_2015_varOfInterest, select = c(Professional, Service, Office, Construction, Production, Unemployment, IncomePerCap))
str(Work_2015)

Ethnic_2015 <- subset(full_2015_varOfInterest, select = c(Hispanic, White, Black, Native, Asian, IncomePerCap))
str(Ethnic_2015)
```
...
```{r Cor w/i Freedom}
loadPkg("corrplot")
Freedom_2015_cor <- cor(Freedom_2015)
