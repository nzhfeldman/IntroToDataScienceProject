...
full_2017IPC <- subset(full_2017IPC, select = -c(Pacific, Income, Poverty, ChildPoverty, Employed, PrivateWork, PublicWork, FamilyWork, fprank, rprank, pfrank, efrank) )
