...
dat1 <- subset(dat1, select = c(FiscalPolicy,EconomicFreedom, RegulatoryPolicy, PersonalFreedom, OverallFreedom, TotalPop, Hispanic, White, Black, Asian, Professional, Service, Office, Construction, Production, Unemployment))
...
```{r DF and cor Setup} 
dat1_varOfInterest <- dat1 %>% select(colnames(full_2015))
