...
An analysis using this dataset was uploaded to Kaggle in 2018. It is titled "Child Poverty in New York City: A Comprehensive Study" and analyzed child poverty rates in New York City and how they vary by location and other factors (RNA, 2018). Although it was conducted using the same dataset, it focused only in New York city and not the entire country.
