...
#White
dat3 <- data.frame(dat2$IncomePerCap,dat2$White)
...
#Hispanic 
dat4 <- data.frame(dat2$IncomePerCap,dat2$Hispanic)
df2 <- scale(dat4)
set.seed(1000)
k3 <- kmeans(df2, centers = 2, nstart = 25)
str(k3)
k3
#black 
dat5 <- data.frame(dat2$IncomePerCap,dat2$Black)
df3 <- scale(dat5)
set.seed(1000)
...
k4
#Asian 
dat6 <- data.frame(dat2$IncomePerCap,dat2$Asian)
df4 <- scale(dat6)
set.seed(1000)
k5 <- kmeans(df4, centers = 2, nstart = 25)
str(k5)
k5
#Native 
dat7 <- data.frame(dat2$IncomePerCap,dat2$Native)
df5 <- scale(dat7)
set.seed(1000)
k6 <- kmeans(df5, centers = 2, nstart = 25)
str(k6)
k6
...
v1=c(dat2$IncomePerCap) # column 20
 # use the example in the pptx, try k=2 clusters
data <- scale(v1)
...
```{r analysis of profession}
#Work Variations 
dat8 <- data.frame(na.omit(dat2$IncomePerCap,dat2$Professional))
df6 <- scale(dat8)
set.seed(1000)
k7 <- kmeans(df6, centers = 2, nstart = 25)
str(k7)
k7
#Professional
dat9 <- data.frame(na.omit(dat2$IncomePerCap,dat2$Production))
df7 <- scale(dat9)
set.seed(1000)
k8 <- kmeans(df7, centers = 2, nstart = 25)
str(k8)
k8
#Production
