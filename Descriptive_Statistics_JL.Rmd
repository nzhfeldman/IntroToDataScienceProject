...
qqnorm(dat1$PersonalFreedom, main="Q-Q plot of Overall Freedom")
qqline(dat1$PersonalFreedom)
```
...
qqnorm(dat1$SelfEmployed, main="Q-Q plot of Production")
...
#qqplot of Hispanic
qqnorm(dat1$Hispanic, main="Q-Q plot of Production")
...
plot(IncomePerCap ~ GroupWhite, data=dat1, main="IncomePerCap and GroupWhite", col=c("#B5651D", "#A4550A", "#964B00", "#834200") )
summary(dat1$White)
#Histogram of White
hist(dat1$White, 
        col = "#964B00",
...
#qqplot of White
qqnorm(dat1$White, main="Q-Q plot of Production")
qqline(dat1$White)
