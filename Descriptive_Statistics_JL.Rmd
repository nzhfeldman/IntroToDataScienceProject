...
plot(IncomePerCap ~ GroupAsian, data=dat1, main="IncomePerCap and GroupAsian", col=c("#FFE6C8","#FFCCBE", "#EFABA0" ) )
summary(dat1$Asian)
#Histogram of Asian
hist(dat1$Asian, 
        col = "#FFE6C8",
...
#Group by native
#GroupNative1<-dat1[-order(dat1$Native),]
#order(x, decreasing=TRUE)
#GroupNative <- quant_groups(dat1$Native, 4)
#str(GroupNative)
#Boxplot of IncomePerCap by White Population
#plot(IncomePerCap ~ GroupNative, data=dat1, main="IncomePerCap and GroupNative", col=c("#A9AB98","#949180", "#7D7968", "#5E594F") )
summary(dat1$Native)
#Histogram of Native
hist(dat1$Native, 
        col = "#949180",
